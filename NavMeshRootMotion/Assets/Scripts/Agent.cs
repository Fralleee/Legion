...
public class Agent : MonoBehaviour
{
  ...
  void Update()
  {
    ...
    {
      Quaternion DesiredRotation = Quaternion.LookRotation(agent.desiredVelocity);
      transform.rotation = Quaternion.Lerp(transform.rotation, DesiredRotation, Time.time * 0.01f);
    }
