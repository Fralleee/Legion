...
////// Emissive:
                ...
                float3 emissive = (((_GlowColors*(node_2425.rgb*node_8369.a))+(node_8369.rgb*_GlowExternal))*i.vertexColor.a*i.vertexColor.rgb);
                float3 finalColor = emissive;
                return fixed4(finalColor,((node_8369.a+node_8369.rgb)*i.vertexColor.a).r);
            }
            ENDCG
        }
    }
