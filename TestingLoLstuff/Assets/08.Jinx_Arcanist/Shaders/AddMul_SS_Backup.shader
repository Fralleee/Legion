...
////// Emissive:
                ...
                float2 node_1800 = ((float2(_U_Speed,_V_Speed)*node_3262.g)+i.screenPos.rg);
                ...
                float3 emissive = lerp( _HasNoiseEmissive_var, (_HasNoiseEmissive_var*node_7176), _HasEmissiveDepth );
                ...
                fixed4 finalRGBA = fixed4(finalColor,lerp( _HasNoiseOpacity_var, (_HasNoiseOpacity_var*node_7176), _HasOpacityDepth ));
