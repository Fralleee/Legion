...
Shader "Custom/AddMul_FixedMask" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _FixedMask; uniform float4 _FixedMask_ST;
            struct VertexInput {
...
////// Emissive:
                ...
                float4 node_8195 = tex2D(_FixedMask,TRANSFORM_TEX(i.uv0, _FixedMask));
                float3 emissive = (((_FinalEmissive*lerp( _HasNoiseEmissive_var, (_HasNoiseEmissive_var*node_7176), _HasEmissiveDepth ))*_FinalMix)*node_8195.r);
                ...
                fixed4 finalRGBA = fixed4(finalColor,(((lerp( _HasNoiseOpacity_var, (_HasNoiseOpacity_var*node_7176), _HasOpacityDepth )*_FinalOpacity)*_FinalMix)*node_8195.r));
