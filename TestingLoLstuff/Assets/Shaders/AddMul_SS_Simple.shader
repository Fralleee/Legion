...
Shader "Custom/AddMul" {
    Properties {
        ...
        [MaterialToggle] _isScreenSpace ("isScreenSpace?", Float ) = 0
...
////// Emissive:
                ...
                float2 node_1800 = ((float2(_U_Speed,_V_Speed)*node_3262.g)+lerp( i.uv0, i.screenPos.rg, _isScreenSpace ));
                ...
                float node_6456 = (_FresnelPower*(1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelExp)));
                float3 emissive = (((_FinalEmissive*lerp( _HasNoiseEmissive_var, (_HasNoiseEmissive_var*node_7176), _HasEmissiveDepth ))*_FinalMix)*node_6456);
                ...
                fixed4 finalRGBA = fixed4(finalColor,(((lerp( _HasNoiseOpacity_var, (_HasNoiseOpacity_var*node_7176), _HasOpacityDepth )*_FinalOpacity)*_FinalMix)*node_6456));
