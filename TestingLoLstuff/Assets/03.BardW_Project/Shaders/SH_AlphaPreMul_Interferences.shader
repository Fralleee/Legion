...
////// Emissive:
                ...
                float3 emissive = ((node_702.r*node_9303*i.vertexColor.rgb*node_7736)*node_4164);
                float3 finalColor = emissive;
                return fixed4(finalColor,(node_4164*(node_702.r*(node_9303+(node_7736*_Add))*i.vertexColor.a)));
            }
            ENDCG
        }
    }
